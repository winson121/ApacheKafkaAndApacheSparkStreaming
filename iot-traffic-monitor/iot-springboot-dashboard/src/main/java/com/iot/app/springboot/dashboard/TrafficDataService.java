...
import com.iot.app.springboot.dao.DayTimeAccidentDataRepository;
...
public class TrafficDataService {
	...
	@Autowired
	private DayTimeAccidentDataRepository trafficAccidentsRepository;
	
	private static DateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	private static String cid = new String();
	...
	public void trigger() {
		...
		List<DayTimeAccidentData> trafficAccidentList = new ArrayList<DayTimeAccidentData>();
		//Call dao methods
		...
		trafficAccidentsRepository.findTrafficDataByCity(cid).forEach(e -> trafficAccidentList.add(e));
		...
		response.setTrafficAccidents(trafficAccidentList);
