...
public class Response implements Serializable {
	...
	private List<DayTimeAccidentData> trafficAccidents;
	...
	public List<DayTimeAccidentData> getTrafficAccidents(){
		return trafficAccidents;
	}
	public void setTrafficAccidents(List<DayTimeAccidentData> trafficAccidents){
